...
export default function DomeGallery({
  ...
  useEffect(() => {
    ...
    const close = () => {
      ...
      // Restore the tile to its place in the sphere: the open animation
      // rotated the parent via --rot-*-delta and hid the tile. Reset both
      // so the tile animates back to its original orientation.
