...
export const socios: Socio[] = [
  ...
  // The two non-shopping categories, so the section rules (Informes and
  // Estadísticas are shopping-only) are exercised by the mock data too.
  {
    id: "soc-5",
    nombre: "Andrés Rivas",
    shopping: "Xperts Consultores",
    email: "arivas@xperts.com.ar",
    cargo: "Director",
    estado: "activo",
    role: "socio",
    categoria: "proveedor",
    invitacionStatus: "aceptada",
    invitacionEnviadaAt: iso(2026, 2, 10),
    createdAt: iso(2026, 2, 10),
    updatedAt: iso(2026, 2, 10),
  },
  {
    id: "soc-6",
    nombre: "Carla Ibáñez",
    shopping: "Cinemacenter",
    email: "cibanez@cinemacenter.com.ar",
    cargo: "Gerente de Expansión",
    estado: "activo",
    role: "socio",
    categoria: "retailer",
    invitacionStatus: "aceptada",
    invitacionEnviadaAt: iso(2026, 2, 12),
    createdAt: iso(2026, 2, 12),
    updatedAt: iso(2026, 2, 12),
  },
  {
    id: "adm-1",
